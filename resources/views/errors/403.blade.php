...
<head>
    ...
    <title>Permission denied | 403 - Access Denied</title>
...
<div class="cover">
    ...
    <p class="lead">You did not have permission to access this pages </p>
    <a @if(Auth::user()->is_admin == 1)
             href="/admin"
...
<footer>
    <p>Technical Contact: <a href="{{ url('/') }}">admin (at) startupipo (dot) com</a></p>
</footer>
