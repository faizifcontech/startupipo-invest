                 ...
                 @elseif(! count($semuaSenarai) > 0)
                    <div class="col-md-offset-1 col-md-10">
                        <div class="panel panel-contrast">
                            ...
                            <div class="panel-body">
                                <p>We didnt found any  active record. Get in touch with your agent and start funding today. The goal of investing is make more money. Investing now, and earn profit.</p>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach($semuaSenarai as $senarai)
                                        <tr>
                                            ...
                                            <td class="actions"><a target="_blank" @if($profileCheck) href="{{ action('AgreementController@pdfAgreement', $senarai->id) }}" @else data-toggle="modal" data-target="#mod-warning" @endif class="icon"><i class="mdi mdi-file-text"></i></a></td>
                                            <td class="text-right">
                                                @if($senarai->package == 3)
                                                    <?php
                                                ...
                                                @elseif($senarai->package == 2)
                                                    ...
                                                    $nowTime = strtotime(date("2018-04-12 H:i:s"));
                                                    ?>
                                                    @if($validDate <= $nowTime )
                                                            {!! Form::open(['action' => ['ShareController@clearPayback', $senarai->id ]]) !!}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <h3>Warning!</h3>
                        <p>We did not found your profile record. <br>To view your agreement, Please add your profile info.</p>
                        <div class="xs-mt-50">
                            <button type="button" data-dismiss="modal" class="btn btn-space btn-default">Cancel</button>
                            <a href="{{ action('ProfileController@index') }}"  class="btn btn-space btn-warning">Create Profile</a>
                        </div>
                    </div>
                </div>
